...
@MyBot.dp.callback_query_handler(posts_cb.filter(action=['bagration_admin_add_user']))
async def call_bagration_admin_add_user(call: types.CallbackQuery = None, callback_data: dict = None,
