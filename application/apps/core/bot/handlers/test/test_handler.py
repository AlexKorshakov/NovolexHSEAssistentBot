...
from apps.core.bot.bot_utils.check_access import (check_super_user_access,
                                                  ...
                                                  get_hse_role_receive_df, check_user_access)
...
# @rate_limit(limit=10)
@MyBot.dp.message_handler(Command('test_command'), filter_is_private, state='*')
async def test_handler(message: types.Message = None, *, hse_user_id: int | str = None,
